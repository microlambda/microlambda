...
import { ApiGatewayV2Client, DeleteDomainNameCommand, DeleteDomainNameRequest } from '@aws-sdk/client-apigatewayv2';
import { getCustomDomain } from './get-custom-domain';
import { maxAttempts } from '../max-attempts';
import { IBaseLogger } from '@microlambda/types';

export const deleteCustomDomain = async (region: string, domainName: string, logger?: IBaseLogger): Promise<void> => {
