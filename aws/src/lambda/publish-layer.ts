...
export const publishLayer = async (zipLocation: string, stackName: string, serverless: ServerlessInstance, config?: IPackagrConfig, logger?: IBaseLogger): Promise<string | undefined> => {
