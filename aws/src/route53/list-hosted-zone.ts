...
import { HostedZone, ListHostedZonesCommand, ListHostedZonesRequest, Route53Client } from '@aws-sdk/client-route-53';
import { serviceName } from './service-name';
import { maxAttempts } from '../max-attempts';

export const listHostedZones = async (logger?: IBaseLogger): Promise<Array<HostedZone>> => {
