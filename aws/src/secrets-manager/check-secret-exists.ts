 ...
 */
export const checkSecretExists = async (region: string, name: string, logger?: IBaseLogger): Promise<boolean> => {
  ...
  do {
    ...
    try {
      ...
      found = !!result.SecretList && result.SecretList.some((secret) => secret.Name === name);
