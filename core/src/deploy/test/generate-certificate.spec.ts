...
describe('The generate certificate step', () => {
  test.todo('should check that the matching certificate is issued');
  test.todo('should throw if the matching certificate is pending validation');
  test.todo('should throw if the matching certificate is not validated');
  test.todo('should create the direct upper level wildcard certificate if no matching certificate');
  test.todo('should create the DNS record with the right parameters');
  test.todo('should poll every minutes to check if the certificate is created');
  test.todo('should succeed if certificate is issued within 5 minutes');
  test.todo('should throw if certificate is not issued within 5 minutes');
});
